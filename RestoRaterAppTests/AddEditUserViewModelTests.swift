...
class AddEditUserViewModelTests: XCTestCase {
    ...
    func testInitializationForAddScenario() throws {
        let viewModel = AddEditUserViewModel(scenario: .add, dataManager: dataManager)
    ...
    func testInitializationForEditScenario() throws {
        ...
        let viewModel = AddEditUserViewModel(scenario: .edit, dataManager: dataManager, user: mockUser)
